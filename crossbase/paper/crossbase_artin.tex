...
entangled pairs. Both the pointwise obstruction and the Kummer-degree
...
$\sigma_0$ by a factor of $476$: knowing that $a$ is a
  ...
  \item \emph{Where the exclusion wins.} The only two negative
    ...
    are triple-completed, but dependence alone is not the
    discriminant: fifteen of the $66$ pairs are triple-completed and thirteen of those are positively correlated. What singles out these two is the conductor of
...
primes excluded). ``Dep.''\ marks triple-completed pairs.}
\label{tab:top}
...
The sign reversal is Theorem~\ref{thm:pair} operating statistically. For every pair, triple-completed or not, the primes split into two halves according to the sign
...
$x = 10^9$. ``Dep.''\ marks triple-completed pairs. The final two
